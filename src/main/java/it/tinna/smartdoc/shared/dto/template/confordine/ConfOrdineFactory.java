package it.tinna.smartdoc.shared.dto.template.confordine;
...
public class ConfOrdineFactory {
	
	public static List<ConfOrdineTemplate> create() {
		ConfOrdineTemplate template = new ConfOrdineTemplate();
