package it.tinna.smartdoc.shared.dto.template.notecredito;
...
public class NotaCreditoFactory {
	
	public static List<NotaCreditoTemplate> create() {
		NotaCreditoTemplate template = new NotaCreditoTemplate();
...
//		prodotti.add(pdDto);
		...
		List<ScadenzaPagamentoDocumentoDto> scadenze = new ArrayList<ScadenzaPagamentoDocumentoDto>();
		ScadenzaPagamentoDocumentoDto sDto = new ScadenzaPagamentoDocumentoDto();
		sDto.setDtScadenza("15/01/2014");
		sDto.setImportoFormattato("100,00");
		scadenze.add(sDto);
		//seconda scadenza
		sDto = new ScadenzaPagamentoDocumentoDto();
		sDto.setDtScadenza("16/01/2014");
		sDto.setImportoFormattato("100,00");
		scadenze.add(sDto);
		template.setScadenze(scadenze);
