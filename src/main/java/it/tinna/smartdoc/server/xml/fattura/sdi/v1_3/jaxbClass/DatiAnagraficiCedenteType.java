 ...
 *       &lt;sequence&gt;
 *         &lt;element name="IdFiscaleIVA" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}IdFiscaleType"/&gt;
 *         &lt;element name="CodiceFiscale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}CodiceFiscaleType" minOccurs="0"/&gt;
 *         &lt;element name="Anagrafica" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}AnagraficaType"/&gt;
 *         &lt;element name="AlboProfessionale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}String60LatinType" minOccurs="0"/&gt;
 *         &lt;element name="ProvinciaAlbo" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}ProvinciaType" minOccurs="0"/&gt;
 *         &lt;element name="NumeroIscrizioneAlbo" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}String60Type" minOccurs="0"/&gt;
 *         &lt;element name="DataIscrizioneAlbo" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/&gt;
 *         &lt;element name="RegimeFiscale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}RegimeFiscaleType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    protected Date dataIscrizioneAlbo;
    @XmlElement(name = "RegimeFiscale", required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter13 .class)
    protected RegimeFiscaleEnum regimeFiscale;
     ...
     *     
     */
    public void setDataIscrizioneAlbo(Date value) {
     ...
     *     
     */
    public RegimeFiscaleEnum getRegimeFiscale() {
     ...
     *     
     */
    public void setRegimeFiscale(RegimeFiscaleEnum value) {
