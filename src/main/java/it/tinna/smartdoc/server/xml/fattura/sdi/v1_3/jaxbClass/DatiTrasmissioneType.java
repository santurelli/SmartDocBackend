 ...
 *       &lt;sequence&gt;
 *         &lt;element name="IdTrasmittente" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}IdFiscaleType"/&gt;
 *         &lt;element name="ProgressivoInvio" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}String10Type"/&gt;
 *         &lt;element name="FormatoTrasmissione" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}FormatoTrasmissioneType"/&gt;
 *         &lt;element name="CodiceDestinatario" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}CodiceDestinatarioType"/&gt;
 *         &lt;element name="ContattiTrasmittente" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}ContattiTrasmittenteType" minOccurs="0"/&gt;
 *         &lt;element name="PECDestinatario" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}EmailType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "FormatoTrasmissione", required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter5 .class)
    protected FormatoTrasmissioneEnum formatoTrasmissione;
     ...
     *     
     */
    public FormatoTrasmissioneEnum getFormatoTrasmissione() {
     ...
     *     
     */
    public void setFormatoTrasmissione(FormatoTrasmissioneEnum value) {
