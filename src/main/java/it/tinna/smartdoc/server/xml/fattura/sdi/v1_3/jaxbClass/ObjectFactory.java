 ...
 * generated in the it.tinna.smartdoc.server.xml.fattura.sdi.v1_3.jaxbClass package. 
...
public class ObjectFactory {
    ...
    private final static QName _FatturaElettronica_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3", "FatturaElettronica");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.tinna.smartdoc.server.xml.fattura.sdi.v1_3.jaxbClass
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3", name = "FatturaElettronica")
    ...
    public JAXBElement<Integer> createSignatureMethodTypeHMACOutputLength(Integer value) {
        return new JAXBElement<Integer>(_SignatureMethodTypeHMACOutputLength_QNAME, Integer.class, SignatureMethodType.class, value);
    }
