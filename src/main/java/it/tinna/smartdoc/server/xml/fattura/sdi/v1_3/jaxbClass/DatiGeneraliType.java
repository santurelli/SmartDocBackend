 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DatiGeneraliDocumento" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiGeneraliDocumentoType"/&gt;
 *         &lt;element name="DatiOrdineAcquisto" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiDocumentiCorrelatiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiContratto" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiDocumentiCorrelatiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiConvenzione" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiDocumentiCorrelatiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiRicezione" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiDocumentiCorrelatiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiFattureCollegate" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiDocumentiCorrelatiType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiSAL" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiSALType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiDDT" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiDDTType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="DatiTrasporto" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiTrasportoType" minOccurs="0"/&gt;
 *         &lt;element name="FatturaPrincipale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}FatturaPrincipaleType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
