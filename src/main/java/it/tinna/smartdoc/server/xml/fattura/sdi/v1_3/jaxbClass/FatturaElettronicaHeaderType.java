 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DatiTrasmissione" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}DatiTrasmissioneType"/&gt;
 *         &lt;element name="CedentePrestatore" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}CedentePrestatoreType"/&gt;
 *         &lt;element name="RappresentanteFiscale" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}RappresentanteFiscaleType" minOccurs="0"/&gt;
 *         &lt;element name="CessionarioCommittente" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}CessionarioCommittenteType"/&gt;
 *         &lt;element name="TerzoIntermediarioOSoggettoEmittente" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}TerzoIntermediarioSoggettoEmittenteType" minOccurs="0"/&gt;
 *         &lt;element name="SoggettoEmittente" type="{http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.3}SoggettoEmittenteType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "SoggettoEmittente", type = String.class)
    @XmlJavaTypeAdapter(Adapter12 .class)
    protected SoggettoEmittenteEnum soggettoEmittente;
     ...
     *     
     */
    public SoggettoEmittenteEnum getSoggettoEmittente() {
     ...
     *     
     */
    public void setSoggettoEmittente(SoggettoEmittenteEnum value) {
