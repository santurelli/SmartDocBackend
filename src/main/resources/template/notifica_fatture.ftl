...
<html>
    <head>
        ...
        <meta property="og:title" content="SmartDoc - Fatture con anomalie" />

        <title>SmartDoc - Fatture con anomalie</title>
		<style type="text/css">
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">SmartDoc</h1>
                                                                <h4 class="h4">Report anomalie fatture elettroniche</h4>
                                                            </div>
														</td>
                                                    </tr>
													<tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
														  <span class="bodyContent">
															<div mc:edit="std_content00" class="bodyContent">
																<strong>Elenco fatture</strong>
															</div>
														  </span>
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              <tr>
                                                              	  <th scope="col" valign="top" width="12%" class="dataTableHeading" mc:edit="data_table_heading00">
                                                                    PUNTO V.
                                                                  </th>
                                                                  ...
                                                                  <th scope="col" valign="top" width="13%" class="dataTableHeading" mc:edit="data_table_heading01">
                                                                    STATO
                                                                  </th>
															  ...
															  <#list notifiche as notifica>
																<tr mc:repeatable>
																  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                    <#if notifica.getDbKey()??>${notifica.getDbKey()}</#if>
                                                                  </td>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content02">
                                                                    <#if notifica.getNumeroDocumento()??>${notifica.getNumeroDocumento()}</#if>
                                                                  </td>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content01">
                                                                    <#if notifica.getDataDocumento()??>${notifica.getDataDocumento()}</#if>
                                                                  </td>
																  <td valign="top" class="dataTableContent" mc:edit="data_table_content03">
                                                                    <#if notifica.getTipoEsito()?? && notifica.getTipoEsito() == 'NS'>Scartata<#else>Errore xml</#if>
                                                                  </td>
																  <td valign="top" class="dataTableContent" mc:edit="data_table_content04">
                                                                    <#if notifica.getErroreSdi()??>${notifica.getErroreSdi()}</#if>
                                                                  </td>
																  <td valign="top" class="dataTableContent" mc:edit="data_table_content05">
                                                                    <#if notifica.getErroreValidazioneXml()??>${notifica.getErroreValidazioneXml()}</#if>
                                                                  </td>
															    </tr>
															  </#list>
                                                          </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; ${currentYear} SmartDoc, Tutti i diritti riservati.</em>
																<br />
                                                            </div>
                                                        </td>
                                                    </tr>
